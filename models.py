...
class Usuario(db.Model):
    ...
    perfil = db.Column(db.Enum(*PERFIS, name='perfil_usuario'), nullable=False)
...
class Paciente(db.Model):
    ...
    status = db.Column(db.Enum(*STATUS_PACIENTE, name='status_paciente'), nullable=False, default='potencial_doador')
